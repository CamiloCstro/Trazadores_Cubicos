...
data3 = pd.read_csv('DatosEMA-2020-03-29-Radiación.csv', sep=';')
x3 = np.array(data3['MIN'])
y3 = np.array(data3['RADI'])

plt.scatter(x3, y3)
plt.xlabel("Minuto")
plt.ylabel("Nivel de Radiación")
plt.title("Radiación 29-03-2020")
plt.show()
...
n = len(x3)
px_tabla = traza3natural(x3, y3)

# SALIDA
print('Polinomios por tramos: ')
for tramo in range(1, n, 1):
    print(' x = [' + str(x3[tramo - 1])
          + ',' + str(x3[tramo]) + ']')
...
# Gráfica
plt.plot(x3, y3, 'ro', label='puntos')
