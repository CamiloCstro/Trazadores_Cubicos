...
data2 = pd.read_csv('DatosEMA-2020-03-30-Radiación.csv', sep=';')


x2 = np.array(data2['MIN'])
y2 = np.array(data2['RADI'])

plt.scatter(x2, y2)
plt.xlabel("Minuto")
plt.ylabel("Nivel de Radiación")
plt.title("Radiación 30-03-2020")
plt.show()
...
# Gráfica
plt.plot(x2, y2, 'ro', label='puntos')
